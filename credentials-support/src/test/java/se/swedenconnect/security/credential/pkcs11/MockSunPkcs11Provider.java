...
public class MockSunPkcs11Provider extends Provider {
  ...
  public Provider configure(final String configArg) {
    ...
    try {
      ...
      try (final Scanner scanner = new Scanner(new ByteArrayInputStream(configData.getBytes()))) {
  ...
  public static class MockKeyStoreSpi extends KeyStoreSpi {
    ...
    @Override
    public void engineStore(final OutputStream stream, final char[] password) throws IOException {
