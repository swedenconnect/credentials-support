...
/**
 * Implements a {@link PkiCredentialContainer} based on a {@link KeyStore} that is held in memory (i.e. not using an HSM
 * device for key storage).
 * <p>
 * Also see {@link InMemoryPkiCredentialContainer} that is an in-memory container that does not use key stores (and
...
public class SoftPkiCredentialContainer extends AbstractKeyStorePkiCredentialContainer {
   ...
   */
  public SoftPkiCredentialContainer(@Nonnull final String providerName) throws KeyStoreException {
   ...
   * @throws KeyStoreException for errors creating the key store
   */
  public SoftPkiCredentialContainer(@Nonnull final Provider provider) throws KeyStoreException {
    this(provider, null);
  }
   ...
   * @throws KeyStoreException for errors creating the key store
   */
  public SoftPkiCredentialContainer(@Nonnull final String providerName, @Nullable final String password)
   ...
   * @throws KeyStoreException for errors creating the key store
   */
  public SoftPkiCredentialContainer(@Nonnull final Provider provider, @Nullable final String password)
      throws KeyStoreException {
