...
public class RsaKeyPairGeneratorFactory extends AbstractKeyPairGeneratorFactory {
   ...
   */
  public RsaKeyPairGeneratorFactory(@Nonnull final String keyTypeName, final int keySize) {
    super(keyTypeName);
  ...
  @Override
  @Nonnull
  public KeyPairGenerator getKeyPairGenerator(@Nonnull final Provider provider) throws NoSuchAlgorithmException {
