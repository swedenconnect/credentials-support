...
public interface PkiCredentialContainer {
   ...
   */
  @Nonnull
  String generateCredential(@Nonnull final String keyTypeName)
   ...
   */
  @Nonnull
  ManagedPkiCredential getCredential(@Nonnull final String alias) throws PkiCredentialContainerException;
   ...
   */
  void deleteCredential(@Nonnull final String alias) throws PkiCredentialContainerException;

  /**
   * Gets the expiry time of the credential specified by alias.
   *
   * @param alias alias of the requested credential
   * @return expiry time for the specified credential or {@code null} if the credential never expires
   * @throws PkiCredentialContainerException error obtaining the expiry time
   */
  @Nullable
  Instant getExpiryTime(@Nonnull final String alias) throws PkiCredentialContainerException;
   ...
   */
  void setKeyValidity(@Nonnull final Duration keyValidity);
   ...
   */
  void setSupportedKeyTypes(@Nonnull final List<String> supportedKeyTypes);
}
