...
public class KeyPairGeneratorFactoryRegistry {
   ...
   */
  @Nonnull
  public static KeyPairGeneratorFactory getFactory(@Nonnull final String keyGenType) throws IllegalArgumentException {
    if (registry.containsKey(keyGenType)) {
      return registry.get(keyGenType);
    }
    final KeyPairGeneratorFactory factory;
   ...
   */
  public static void registerFactory(@Nonnull final String keyGenType, @Nonnull final KeyPairGeneratorFactory factory) {
