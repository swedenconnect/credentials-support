...
public abstract class KeyPairGeneratorFactory {
   ...
   */
  public KeyPairGeneratorFactory(String keyTypeName) {
   ...
   */
  public abstract KeyPairGenerator getKeyPairGenerator(Provider provider) throws NoSuchAlgorithmException, KeyException;
