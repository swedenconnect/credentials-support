...
public class KeyGenType {
  ...
  public static KeyPairGeneratorFactory RSA_2048_Factory = new RsaKeyPairGeneratorFactory(RSA_2048, 2048);
  /**  Key pair generator factory for generating keys of type RSA 3072 */
  public static KeyPairGeneratorFactory RSA_3072_Factory = new RsaKeyPairGeneratorFactory(RSA_3072, 3072);
  /**  Key pair generator factory for generating keys of type RSA  4096 */
  public static KeyPairGeneratorFactory RSA_4096_Factory = new RsaKeyPairGeneratorFactory(RSA_4096, 4096);
  /**  Key pair generator factory for generating keys of type EC NIST P192 */
  public static KeyPairGeneratorFactory EC_P192_Factory = new EcKeyPairGeneratorFactory(EC_P192,
    ECParameterSpecs.NIST_P192);
  /**  Key pair generator factory for generating keys of type EC NIST P224 */
  public static KeyPairGeneratorFactory EC_P224_Factory = new EcKeyPairGeneratorFactory(EC_P224,
    ECParameterSpecs.NIST_P224);
  /**  Key pair generator factory for generating keys of type EC NIST P256 */
  public static KeyPairGeneratorFactory EC_P256_Factory = new EcKeyPairGeneratorFactory(EC_P256,
    ECParameterSpecs.NIST_P256);
  /**  Key pair generator factory for generating keys of type EC NIST P384 */
  public static KeyPairGeneratorFactory EC_P384_Factory = new EcKeyPairGeneratorFactory(EC_P384,
    ECParameterSpecs.NIST_P384);
  /**  Key pair generator factory for generating keys of type EC NIST P521 */
  public static KeyPairGeneratorFactory EC_P521_Factory = new EcKeyPairGeneratorFactory(EC_P521,
    ECParameterSpecs.NIST_P521);
  /**  Key pair generator factory for generating keys of type EC Brainpool P192 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_192_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_192,
    ECParameterSpecs.BRAINPOOL_P192R1);
  /**  Key pair generator factory for generating keys of type EC Brainpool P224 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_224_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_224,
    ECParameterSpecs.BRAINPOOL_P224R1);
  /**  Key pair generator factory for generating keys of type EC Brainpool P256 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_256_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_256,
    ECParameterSpecs.BRAINPOOL_P256R1);
  /**  Key pair generator factory for generating keys of type EC Brainpool P320 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_320_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_320,
    ECParameterSpecs.BRAINPOOL_P320R1);
  /**  Key pair generator factory for generating keys of type EC Brainpool P384 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_384_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_384,
    ECParameterSpecs.BRAINPOOL_P384R1);
  /**  Key pair generator factory for generating keys of type EC Brainpool P512 R1*/
  public static KeyPairGeneratorFactory EC_BRAINPOOL_512_Factory = new EcKeyPairGeneratorFactory(EC_BRAINPOOL_512,
