...
**Note:** OpenSAML 4 is an optional dependency to the **credentials-support** meaning that if you want to use the [OpenSamlCredential](https://github.com/swedenconnect/credentials-support/blob/main/src/main/java/se/swedenconnect/security/credential/opensaml/OpenSamlCredential.java) you need to explicitly include dependencies to the `org.opensaml:opensaml-core` and `org.opensaml:opensaml-security-api` libraries.
